...
const VeiwProduct = () => {
    ...
    useEffect(() => {
      setShowProduct(FruitData.find((i) => i.id == localStorage.getItem('productID')))
    },[]);
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-6">
            <div className="product__details__text">
              ...
              <div className="product__details__price">${ShowProduct?.price}.00</div>
              <p>
              ...
              <a href="js:" className="primary-btn" onClick={() => OnClickAddToCard(ShowProduct)}>
                ADD TO CARD
              </a>
